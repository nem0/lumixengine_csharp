...
namespace Lumix
{
	...
	public class ParticleEmitterPlane : NativeComponent
	{
		...
		public static string GetCmpType() { return "particle_emitter_plane"; }

		public ParticleEmitterPlane(Entity _entity, int _component_id)
		{
			entity = _entity;
		...
		public ParticleEmitterPlane(Entity entity)
		{
